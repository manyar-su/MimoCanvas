...
export const VIDEO_MODELS = [
  ...
  { label: 'OpenAI SORA 2 I2V', key: 'sora-2-i2v', provider: ['runpodImage'], type: 'i2v', supportsLastFrame: true, ratios: ['16:9', '9:16'], durs: [{ label: '4 detik', key: 4 }, { label: '8 detik', key: 8 }, { label: '12 detik', key: 12 }], resolutions: ['720p', '1080p'], defaultResolution: '720p', defaultParams: { ratio: '16:9', duration: 4, resolution: '720p' } },
